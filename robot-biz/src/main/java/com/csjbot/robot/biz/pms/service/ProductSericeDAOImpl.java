...
public class ProductSericeDAOImpl implements ProductServiceDAO {
	...
	public JSONObject login(String username, String password) {
		...
		if (ums_user != null){
			...
			jsonUtil = falJson;
			jsonUtil.setMessage("the user does not exit!");
		}
	...
	// 获得产品信息
	@Override
	public JSONObject getProductInfo(HttpServletRequest request) {
		JsonUtil jsonUtil = sucJson;
		Map<String, Object> result = new HashMap<>();
	...
	// 获得广告信息
	@Override
	public JSONObject getADInfo(HttpServletRequest request) {
		JsonUtil jsonUtil = sucJson;
		Map<String, Object> result = new HashMap<>();
