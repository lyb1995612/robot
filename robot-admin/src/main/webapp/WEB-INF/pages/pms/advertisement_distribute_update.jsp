...
<head>
    ...
    <script src="${path }/scripts/pms/advertisement_distribute_update.js" ></script>
            ...
            <div class="main-content" id="mainContent">
                ...
                <div class="page-content">
                    ...
                    <div class="panel panel-default">
			                    ...
			                    <div class="col-md-4">
			                      <div class="form-group">
			                        <div class="input-group">
			                          ...
			                          <input type="text" class="form-control" id="sn" name="sn" value="${sn}" disabled>		                          
			                        </div>
			                      </div>
			                    </div>
			                  </div>
			          ...
			          <input type="hidden" id="UserRoleRef-totalSize" id="UserRoleRef-totalSize" name="UserRoleRef-totalSize" value="${fn:length(pms_advertisements) }" />
			          <div class="row">
			            <div class="col-xs-12">
			              <table id="tp" class="table table-striped table-hover table-bordered table-responsive">
			                ...
			                <tbody>
			                  ...
			                  <tr>
			                    <td>
			                      <input type="checkbox" id="UserRoleRef-${status.index }-checked" name="checkboxs" value="${pms_product.id }" <c:if test="${pms_advertisement.checked }">checked</c:if>/>
