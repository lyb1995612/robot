...
<head>
    ...
    <script src="${path }/scripts/pms/product_distribute_update.js" ></script>
			            ...
			            <div class="col-xs-12">
			              <table id="tp" class="table table-striped table-hover table-bordered table-responsive" data-url="${path }/role/${role.id }/user/search">
			                ...
			                <tbody>
			                  ...
			                  <tr>
			                    <td>
			                      <input type="checkbox" id="UserRoleRef-${status.index }-checked" name="checkboxs" value="${pms_product.id }" <c:if test="${pms_product.checked }">checked</c:if>/>
