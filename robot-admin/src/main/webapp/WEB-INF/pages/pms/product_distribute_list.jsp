...
<head>
    ...
    <script src="${path }/scripts/pms/product_distribute_list.js" ></script>
</head>  
                    ...
                    <div class="panel panel-default">
		                 <div class="panel-heading panel-title">
		                      <table style="width: 100%;">
	                            <tr>
	                                <td style="width: 15%;text-align: left;">产品分配管理</td>
	                                <td style="width: 10%;text-align: right;">
	                                       <a type="button" class="btn btn-primary" href="${path}/pd/toProduct_distributeAdd">新增产品分配</a>
	                                </td>
	                            </tr>
		                      </table>		                 
		                 </div>
