							...
							<table style="width: 99%;">
								<tr>
									<td style="width: 4%; text-align: left;"><a
										class="btn btn-primary" type="button" href="${path}/adv/list">返回</a></td>
									<td class="panel-title"
										style="width: 96%; text-align: center; font-weight: bold">
										<c:if test="${editable == 1 }">广告编辑</c:if> <c:if
											test="${editable == 0 }">广告详情</c:if>
									</td>
								</tr>
							</table>
						</div>
												...
												<div class="form-group">
													<div class="input-group">
														...
														<input class="form-control" type="text" id="name"
															name="name" maxlength="25" placeholder="请输入广告名称"
															value="${advertisement.name}"
															<c:if test="${editable == 0 }">readonly</c:if> /> <input
															id="id" name="id" value="${advertisement.id}"
															hidden="hidden">
													</div>
												</div>
											</div>
										...
										<div class="col-md-12">
											<c:if test="${editable == 1 }">
												<div class="col-md-6">
													<div class="form-group">
														<div class="input-group">
															<div class="input-group-addon">音&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;频</div>
										...
										<div class="col-md-12">
											<c:if test="${editable == 1 }">
												<div class="col-md-6">
													<div class="form-group">
														<div class="input-group">
															<div class="input-group-addon">视&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;频</div>
															<input class="form-control" type="file" id="vedio"
																name="vedio">
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="input-group">
														...
														<textArea class="form-control" id="memo" name="memo"
															maxlength="256" style="resize: none" rows="4"
															<c:if test="${editable == 0 }">readonly</c:if>>${advertisement.memo}</textArea>
													</div>
												</div>
											</div>
										</div>
