...
<head>
    ...
    <script src="${path }/scripts/cms/robot_list.js"></script>
                    ...
                    <div class="panel panel-default">
		                 <div class="panel-heading panel-title">
		                      <table style="width: 100%;">
	                            <tr>
	                                <td style="width: 15%;text-align: left;">机器人清单</td>
	                                <td style="width: 10%;text-align: right;">
	                                       <a type="button" class="btn btn-primary" href="${path}/crb/toRobotAdd">新增清单</a>
	                                </td>
	                            </tr>
		                      </table>		                 
		                 </div>
