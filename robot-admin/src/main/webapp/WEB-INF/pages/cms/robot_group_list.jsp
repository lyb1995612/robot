...
<head>
    ...
    <script src="${path }/scripts/cms/robot_group_list.js"></script>
                    ...
                    <div class="panel panel-default">
		                 <div class="panel-heading panel-title">
		                      <table style="width: 100%;">
	                            <tr>
	                                <td style="width: 15%;text-align: left;">机器人群组</td>
	                                <td style="width: 10%;text-align: right;">
	                                       <a type="button" class="btn btn-primary" href="${path}/rbg/toRobotGroupAdd">新增群组</a>
	                                </td>
	                            </tr>
		                      </table>		                 
		                 </div>
		                                    ...
		                                    <div class="col-md-3">
		                                        <div class="form-group">
		                                            <div class="input-group">
		                                                ...
		                                                <input  class="form-control" type="text" id="group_name" name="group_name" maxlength="25" />  
		                                            </div>
		                                        </div>
		                                    </div>   
		                                    <div >
